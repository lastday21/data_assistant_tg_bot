...
Revision ID: f4c66b482d66
Revises:
Create Date: 2026-02-09 15:46:43.646524
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_videos_video_created_at", "videos", ["video_created_at"], unique=False
    )
    op.create_index("ix_videos_views_count", "videos", ["views_count"], unique=False)
    op.create_table(
        "video_snapshots",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        "ix_video_snapshots_created_at", "video_snapshots", ["created_at"], unique=False
    )
    op.create_index(
        "ix_video_snapshots_video_id", "video_snapshots", ["video_id"], unique=False
    )
